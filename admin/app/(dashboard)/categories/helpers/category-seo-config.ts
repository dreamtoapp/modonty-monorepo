...
// Combined validator factory for Category SEO Title: checks both SEO title quality and OG tags completeness
const createValidateCategorySEOTitleAndOG = (settings?: SEOSettings): SEOFieldValidator => {
  return (value, data) => {

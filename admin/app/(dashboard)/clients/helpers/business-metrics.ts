import { Client, SubscriptionStatus, PaymentStatus } from "@prisma/client";

interface ClientWithRelations extends Omit<Client, "articlesPerMonth" | "subscriptionEndDate"> {

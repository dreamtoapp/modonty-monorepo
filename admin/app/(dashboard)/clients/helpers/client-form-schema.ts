...
// Email validation
const emailSchema = z.string().email("Must be a valid email address").optional().nullable().or(z.literal(""));
...
// Saudi Arabia Region validation (optional field - allows empty strings)

...
// Combined validator factory for Industry SEO Title: checks both SEO title quality and OG tags completeness
const createValidateIndustrySEOTitleAndOG = (settings?: SEOSettings): SEOFieldValidator => {
  return (value, data) => {
...
export const createIndustrySEOConfig = (settings?: SEOSettings): SEODoctorConfig => ({
  ...
  fields: [
    ...
    { name: "seoTitle", label: "SEO Title & Open Graph", validator: createValidateIndustrySEOTitleAndOG(settings) },

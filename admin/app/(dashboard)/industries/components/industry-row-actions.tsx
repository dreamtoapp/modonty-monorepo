...
interface IndustryRowActionsProps {
  industryId: string;
}

export function IndustryRowActions({ industryId }: IndustryRowActionsProps) {
  ...
  const handleEdit = () => {
    router.push(`/industries/${industryId}/edit`);
  };
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. This will permanently delete this industry and all associated data.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>

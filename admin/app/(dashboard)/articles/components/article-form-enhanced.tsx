                  ...
                  <CardContent className="space-y-4 pt-6">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 p-2 bg-muted rounded-md">
                        ...
                        <span className="text-xs text-muted-foreground">(المؤلف الوحيد)</span>
                      </div>
                      <input type="hidden" name="authorId" value={authors[0]?.id || ""} />
                      <p className="text-xs text-muted-foreground mt-1">
                        جميع المقالات تنسب إلى Modonty
                      </p>
                    </div>
                    <FormNativeSelect
                      label="الحالة"
                  ...
                  <CardContent className="space-y-4 pt-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1 mb-2">
                        Select image from Media table. Featured image ID: {formData.featuredImageId || "Not selected"}
                      </p>
                      {initialData?.featuredImage?.url && (
                        <div className="mt-2">
                          <img
                            src={initialData.featuredImage.url}
                            alt={initialData.featuredImage.altText || ""}
                            className="w-full h-auto max-w-md rounded-md border"
                          />
                        </div>
                      )}
                    </div>
